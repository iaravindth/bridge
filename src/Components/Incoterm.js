        ...
        <div className="row pl-5 pt-4">
                        ...
                        <div class="modal-body">
                            ...
                            <div className="col-6 form-box mt-2">
                                ...
                                <div className="col-6 form-box mt-2">
                                    ...
                                    <input type="email" class="form-control readonly " id="exampleFormControlInput1" placeholder="Incoterm"  ></input>
                                </div>
            ...
            <div className="col-lg-11 table-wraper">
                ...
                <div className="float-right">
                    <button type="button" class="btn btn-line-primary-bridge " data-toggle="modal" data-target=".bd-example-modal-lg" >Add  Incoterm</button>
                </div>
            </div>
